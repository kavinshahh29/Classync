          ...
          <Dialog open={showAnnouncementModal} onOpenChange={setShowAnnouncementModal}>
            ...
            <DialogContent className="sm:max-w-2xl">
              <DialogHeader>
                ...
                <DialogDescription>
                  Post an announcement to the class. All students will receive a notification.
                </DialogDescription>
              </DialogHeader>
        ...
        <div className="lg:col-span-3 space-y-6">
          {announcements.length === 0 ? (
            ...
            announcements
              ...
              .map((announcement) => (
                <Card key={announcement.id} className="bg-white shadow-sm overflow-hidden">
                  <CardHeader className="pb-3 bg-gray-50">
                    <div className="flex items-start justify-between">
                      <div className="flex items-start gap-3">
                        <Avatar className="w-10 h-10 border">
                          <AvatarImage src={`https://ui-avatars.com/api/?name=${encodeURIComponent(announcement.author.email)}&background=random`} />
                          <AvatarFallback>{getInitials(announcement.author.email)}</AvatarFallback>
                        </Avatar>
                        <div>
