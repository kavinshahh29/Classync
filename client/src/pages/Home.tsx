      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-4">
        <div className="text-center relative">
          <div className="relative z-10">
            {isAdmin ? (
              <h1 className="text-9xl font-extrabold text-yellow-400">
                Welcome, Admin!
              </h1>
            ) : (
            ...
            <p className="text-gray-300 text-xl max-w-3xl mx-auto mb-12 leading-relaxed">
              Elevate your teaching experience with our comprehensive classroom
              management platform designed for modern educators.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 mt-4 mb-10">
        <div className="text-center mb-6">
          <p className="text-gray-400 max-w-3xl mx-auto">
            Everything you need to create an engaging and effective virtual
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <FeatureCard
              key={index}
              icon={feature.icon}
              title={feature.title.replace("MyClassess", "Classes")}
